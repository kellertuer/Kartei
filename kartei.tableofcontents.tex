...
\begin{longtable}{>{\raggedleft}m{2.5em}b{\textwidth-6\tabcolsep-8em}p{5.5em}}%
...
\newcommand{\card@addsec}[2]{%
  \ifnum\value{card@toccount}=0%
    ...
    \expandafter\g@addto@macro\expandafter\card@tocinner\expandafter{\card@longtochead{\@tempb \unexpanded{#2}}}%
...
\expandafter\g@addto@macro\expandafter\card@tocinner{\expandafter\@tempc \unexpanded{#2}&}%
