...
\setbox\AtBeginShipoutBox\hbox{
  ...
  {%
    \begin{tikzpicture}[remember picture,yshift=-3in]%
      ...
      \ifcard@useFrontgrid%
        %vertical lines
        \draw[front grid] (\card@hoffset-.499\paperwidth,\card@voffset-.4975\paperheight) -- (\card@hoffset-.499\paperwidth,\card@voffset+.4975\paperheight);%
        \draw[front grid] (\card@hoffset+.499\paperwidth,\card@voffset-.4975\paperheight) -- (\card@hoffset+.499\paperwidth,\card@voffset+.4975\paperheight);%
        % horizontal lines
        \draw[front grid] (\card@hoffset-.499\paperwidth,\card@voffset-.4975\paperheight) -- (\card@hoffset+.499\paperwidth,\card@voffset-.4975\paperheight);%
        \draw[front grid] (\card@hoffset-.499\paperwidth,\card@voffset+.4975\paperheight) -- (\card@hoffset+.499\paperwidth,\card@voffset+.4975\paperheight);%
  ...
  {%
    \begin{tikzpicture}[remember picture]%
      ...
      \ifcard@useReargrid%
        %vertical lines
        \draw[rear grid] (\card@hoffset-.499\paperwidth,\card@voffset-.4975\paperheight) -- (\card@hoffset-.499\paperwidth,\card@voffset+.4975\paperheight);%
        \draw[rear grid] (\card@hoffset+.499\paperwidth,\card@voffset-.4975\paperheight) -- (\card@hoffset+.499\paperwidth,\card@voffset+.4975\paperheight);%
        % horizontal lines
        \draw[rear grid] (\card@hoffset-.499\paperwidth,\card@voffset-.4975\paperheight) -- (\card@hoffset+.499\paperwidth,\card@voffset-.4975\paperheight);%
        \draw[rear grid] (\card@hoffset-.499\paperwidth,\card@voffset+.4975\paperheight) -- (\card@hoffset+.499\paperwidth,\card@voffset+.4975\paperheight);%
